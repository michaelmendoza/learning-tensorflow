...
'''
Trains CIFAR-10 model with a ResNet with transfer learning with fine-tuning  
...
Fine-Tuning: https://medium.com/deeplearningsandbox/how-to-use-transfer-learning-and-fine-tuning-in-keras-and-tensorflow-to-build-an-image-recognition-94b0b02444f2
...
def trainOne(model_name):
    ...
    # Fine-Tune Model 
    from ..models.transfer_learning import fine_tune_model
